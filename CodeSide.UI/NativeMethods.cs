...
using static CodeSide.UI.ColorScheme;
...
public class NativeMethods
{
    ...
    [DllImport(uxtheme, EntryPoint = "#136", CallingConvention = CallingConvention.StdCall)]
    public extern static void FlushMenuThemes();
    ...
    public static void EnableAcrylic(IWin32Window window, Color blurColor)
    {
        ...
        var accentPolicy = new AccentPolicy
        {
            ...
            GradientColor = (uint)blurColor.ToArgb()
        };
