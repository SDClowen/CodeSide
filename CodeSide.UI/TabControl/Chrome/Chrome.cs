...
namespace System.Windows.Forms
{
    ...
    public class Chrome : TabControl
    {
        #region	Construction
        ...
        public Chrome()
        {
            ...
            this.DisplayStyle = TabStyle.Angled;
        }
        ...
        private void DrawTabPage(int index, Graphics graphics)
        {
            ...
            using (GraphicsPath tabPageBorderPath = this.GetTabPageBorder(index))
            {
                ...
                using (Brush fillBrush = new SolidBrush(ColorScheme.BorderColor))
                {
        ...
        private void DrawTabBorder(GraphicsPath path, int index, Graphics graphics)
        {
            ...
            if (index == this.SelectedIndex)
            {
                borderColor = Color.FromArgb(33, ColorScheme.BackColorEnd);
            }
            else if (index == this.ActiveIndex)
            {
                borderColor = Color.FromArgb(33, ColorScheme.BackColorHoverEnd);
            }
            else
            {
                borderColor = Color.FromArgb(33, ColorScheme.BackColorEnd);
